          ...
          {canManage && (         
            <>
              ...
              <article className="group flex max-w-xl flex-col items-start justify-between px-5 bg-white dark:bg-gray-700 py-5 rounded-xl shadow-testimonial dark:shadow-none">
                  ...
                  <div className="group relative">
                    <h3 className="mt-3 text-lg/6 font-semibold text-dark dark:text-white group-hover:text-blue">
                      <button onClick={() => navigate(`/add-conference`)}>{t('addEvent')}</button>
                    </h3>
                  </div>
                </article>
            ...
            <article className="group flex max-w-xl flex-col items-start justify-between px-5 bg-white dark:bg-gray-700 py-5 rounded-xl shadow-testimonial dark:shadow-none">
              <div className="relative z-10 mx-auto mb-5 h-[100%] w-[100%] ">
                <img
                  src="/images/dashboard/financial-card.jpg"
                  alt={language === 'ar' ? "البطاقة المالية" : "Financial Card"}
                  width={400}
                  height={400}
                  className="w-full rounded-xl h-[250px] group-hover:scale-105 transition-transform duration-300 ease-in-out"
                />
              ...
              <div className="group relative">
                <h3 className="mt-3 text-lg/6 font-semibold text-dark dark:text-white group-hover:text-blue">
                <button onClick={() => navigate(`/dashboard/financial-card`)}>{language === "ar" ? "البطاقة المالية" : "Financial Card"}</button>
                </h3>
              </div>
            </article>
            ...
            <article className="group flex max-w-xl flex-col items-start justify-between px-5 bg-white dark:bg-gray-700 py-5 rounded-xl shadow-testimonial dark:shadow-none">
              <div className="relative z-10 mx-auto mb-5 h-[100%] w-[100%] ">
                <img
                  src="/images/dashboard/professional-info.jpg"
                  alt={language === 'ar' ? "البيانات الشخصية" : "Personal Information"}
                  width={400}
                  height={400}
                  className="w-full rounded-xl h-[250px] group-hover:scale-105 transition-transform duration-300 ease-in-out"
                />
              ...
              <div className="group relative">
                <h3 className="mt-3 text-lg/6 font-semibold text-dark dark:text-white group-hover:text-blue">
                <button onClick={() => navigate(`/dashboard/personal-info`)}>{language === 'ar' ? "البيانات الشخصية" : "Personal Information"}</button>
                </h3>
              </div>
            </article>
        </div>
